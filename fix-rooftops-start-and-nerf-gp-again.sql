-- REPO COMPANY — REPO ROOFTOPS HOTFIX
-- Fixes Endless/Daily/Hardcore/Time Trial run startup without requiring gen_random_bytes().
-- Applies a further 75% GP reduction to every Repo Rooftops GP source.
-- Safe to run after the previous Repo Rooftops SQL. Existing claimed rewards are not changed.
