-- Repo Company TCG expansion: 19 new cards
-- Safe/additive: preserves existing collections, favourites, pack inventory and XP.
...
begin
  ...
  -- Millennium 2%, Gold Legendary 4%, Rival 7%, Platinum 8%, Full Art 24%, Standard 55%.
  declare
