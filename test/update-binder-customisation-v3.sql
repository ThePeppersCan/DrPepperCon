-- REPO COMPANY: BINDER CUSTOMISATION V3
-- Run this whole file once in Supabase -> SQL Editor.
-- Adds six permanent 10,000 GP legendary binder animation unlocks.
...
-- V3: load the signed-in account's style, owned legendary animations and GP.
...
-- V3: public viewers can see the selected style, including a legendary effect.
