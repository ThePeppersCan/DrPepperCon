...
begin
 ...
 elsif p_action='drop_bucket' then
   st:=jsonb_set(jsonb_set(st,'{has_bucket}','false'::jsonb,true),'{has_milk}','false'::jsonb,true);
 elsif p_action='drop_pot' then
   st:=jsonb_set(jsonb_set(st,'{has_pot}','false'::jsonb,true),'{has_flour}','false'::jsonb,true);
 elsif p_action='drop_egg' then
   st:=jsonb_set(st,'{has_egg}','false'::jsonb,true);
 elsif p_action='drop_milk' then
   st:=jsonb_set(st,'{has_milk}','false'::jsonb,true);
 elsif p_action='drop_grain' then
   st:=jsonb_set(st,'{has_grain}','false'::jsonb,true);
 elsif p_action='drop_flour' then
   st:=jsonb_set(st,'{has_flour}','false'::jsonb,true);
