...
-- Safe to run more than once. Existing fighter designs and all account data are preserved.
...
alter table public.characters
  alter column repo_combat_appearance set default jsonb_build_object(
    'gender', 'male',
    'skin', 'warm',
    'head', 'classic',
    'hair', 'brown',
