-- RepoCompany Shooting Star reward and visual update
-- Safe to run over the existing seven-minute Shooting Star functions.
-- Shooting Star 7-minute cycles
-- One click begins a 7-minute cycle awarding 1,500 Mining XP and 3,800 GP gradually.
...
begin
  ...
  if c.mining_afk_active and c.mining_cycle_start_at is not null then
    ...
    v_target_gp := floor(3800 * v_elapsed / 420)::integer;
